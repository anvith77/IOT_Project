...
def draw_hud():
	screen.fill(black)
	pygame.draw.circle(screen, white, (int(circle1_x), int(circle_y)), int(circle_rad), 5)
	pygame.draw.circle(screen, white, (int(circle2_x), int(circle_y)), int(circle_rad), 5)
	pygame.draw.circle(screen, white, (int(circle3_x), int(circle_y)), int(circle_rad), 5)
	speed_text = headerFont.render("SPEED", True, white)
	rpm_text = headerFont.render("RPM", True, white)
